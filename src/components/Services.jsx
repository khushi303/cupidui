...
const Services = () => {
    return (
        <div id="Services" className='bg-bgservice bg-no-repeat bg-cover bg-center xl:py-24 py-16 relative'>
            <div className='container xl:max-w-[1320px] xl:px-3 px-5 mx-auto lg:py-1 relative z-10'>
