function ServiceCard(props) {
    ...
    return (
        <div className={`pt-4 px-2 lg:pt-0 lg:px-0 ${width}`}>
            <div className='px-7 md:h-[259px] md:py-10 py-5 h-full rounded-2xl shadow-[0px_0px_0px_1px_#F4F4F51A] bg-lightgray-500 group relative overflow-hidden z-10 hover:bg-cardgradient transition-all duration-300 ease-linear cursor-pointer'>
                {props.svg}
