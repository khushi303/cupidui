        ...
        <>
            <div className='container xl:max-w-[1320px] px-3 md:pt-10 pt-6 mx-auto'>
                ...
                <div id='home' className='sm:pt-16.5 pt-12 flex items-center flex-col justify-center relative z-10'>
                    <h1 className='font-bold sm:text-2xxl text-5xl leading-[46px] text-white sm:leading-[65px] text-center'>Unleash <span className='bg-clip-text text-transparent bg-textgradient'>Creativity</span>,
