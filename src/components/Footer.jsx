        ...
        <>
            <div className='relative overflow-hidden'>
                <div className='container mx-auto px-3 max-w-[1320px] lg:pt-32 lg:pb-40 md:py-32 py-10 relative z-20'>
                    <h2 className='font-semibold sm:text-2xxl text-5xl leading-[72px] sm:leading-[65px] text-center text-white mb-6 relative z-20'>Be part of the future of <span className='md:block'>IdentityHub</span><div className='absolute -bottom-3.5 left-0 right-0 flex items-center justify-center'><Gradientline /></div></h2>
