    ...
    return (
        <>
            <div className='relative overflow-hidden'>
                <div className='container mx-auto px-3 max-w-[1320px] lg:pt-32 lg:pb-40 md:py-32 py-10 relative z-10'>
                    <h2 className='font-semibold sm:text-2xxl text-5xl leading-[46px] sm:leading-[65px] text-center text-white mb-6 relative'>Be part of the future of <span className='md:block'>IdentityHub</span><div className='absolute -bottom-2 left-0 right-0 flex items-center justify-center'><Gradientline /></div></h2>
                    ...
                    <div className='flex items-center justify-center '>
                        <button className='mt-8 px-5 py-3 bg-btngradientfooter rounded-xl hover:shadow-gradientRed transition-all duration-300 ease-linear text-base font-medium text-white text-center'>Start free trail</button>
                    </div>
                    <div className='absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center'><Pattern /></div>
                </div>
