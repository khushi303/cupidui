...
const Priceing = () => {
    ...
    return (
        <div id='Pricing' className='relative py-10 lg:pt-20 md:pb-0 md:pt-14 lg:mt-20'>
            <div className='container xl:max-w-[1209px] px-3 mx-auto lg:pt-2'>
                ...
                <div className='bg-lightgray-700 rounded-[41px] p-1 max-w-[192px] mx-auto w-full flex justify-between md:mt-[44.5px] mt-6'>
                    <button onClick={() => setToggle(1)} className={`py-[6px] px-[18px] rounded-[48px] text-base  transition-all duration-300 ease-linear font-medium text-white ${toggle === 1 ? "bg-lightgray-700" : ""}`}>Yearly</button>
                    <button onClick={() => setToggle(2)} className={`py-[6px] px-[18px] rounded-[48px] text-base font-medium text-white transition-all duration-300 ease-linear ${toggle === 2 ? "bg-lightgray-700" : ""}`}>Monthly</button>
                </div>
                ...
                <div className='flex items-center justify-center sm:mt-12 mt-10'>
                    <a href='https:' className='bg-lightgray-700 inline-flex items-center justify-center sm:flex-row flex-col text-white sm:px-4 px-8 py-1.5 sm:rounded-2md rounded-3xl sm:gap-2 gap-1 group'><p className='font-medium text-2sm leading-17 opacity-60 tracking-tightest'>Want enterprise features?</p><p className='flex items-center gap-1 font-bold text-2sm tracking-tightest leading-17'>Tell us more <WhiteArrow /></p></a>
                </div>
            </div>
